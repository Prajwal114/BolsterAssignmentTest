...
describe('Tests API for ReqRes.in', () => {
    let creds =null
    before(()=>{
  ...
  it('1.GET Request: Users List on Page 2', () => {
    const api = creds.api;
  ...
  it('3.GET Request:User by ID which is not present in backend ', () => {
    const api = creds.api;
  ...
  it('4.GET Request: Unknown Data(List<Resource>)', () => {
  ...
  it('5.GET Request: Unknown(Single<Resource>) by ID', () => {
    const api = creds.api;
  ...
  it('6.GET Request: Unknown(Single<Resource> NOT FOUND) by ID', () => {
    const api = creds.api;
  ...
  it('7.POST Request: Create an User', () => {
    const api = creds.api;
    const newUser = {
      name: api.name,
      job: api.job,
  ...
  it('8.PUT Request: Update the User', () => {
    const api = creds.api;
